...
from app.schemas.persona import ReplySpec
from app.services.llm_service import generate_messages
from app.services.persona_renderer import render_persona_reply
from app.services.persona_service import build_persona_context_for_mode
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dataset",
        default="../docs/evaluation/persona_v1/cases.jsonl",
    )
    parser.add_argument(
        "--output-dir",
        default="../evaluation_results/persona_tuning",
    )
