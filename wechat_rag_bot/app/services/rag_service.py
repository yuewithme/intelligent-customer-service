...
7. 信息不足时，先给安全方向，再结合当前销售意图自然追问 1-2 个关键问题；不要像表单，也不要直接转人工。
...
2. 信息不足时，先给安全方向，再结合当前销售意图自然追问 1-2 个关键问题；不要像表单，也不要直接转人工。
    ...
    if policy_decision is not None:
        context = await select_context(
            ContextSelectionInput(
                ...
                sales_memory=user_state.metadata.get("sales_memory", {}),
