...
```powershell
cd apps/api
python -m evaluation.run_evaluation --dataset-dir ../../datasets/evaluation/suites/first_order_sales_flow --output-dir ../../var/evaluation/results/first_order_sales_flow
```
