...
已购客户的问题得到解决，客户用“好的、谢谢、明白了、知道了”等认可并自然收口时，Service SOP 必须在同一轮用三条独立消息完整完成“持续咨询心智 → 会员吸引点 → 未来鉴赏偏好挖需”，不能合并成一条，也不能漏掉其中任何一项。每周上新多款铭品供鉴赏、会员专属折扣活动、后续主动分享实拍与优惠是业务确认可直接表达的长期钩子；客户追问具体日期、品种、数量、折扣、金额、条件或有效期时不编造，简短说明每期安排不同后转向鉴赏偏好。鉴赏偏好会作为有原话证据的稳定记忆保存，本身不构成购买信号，不触发商品查询或卡片。
