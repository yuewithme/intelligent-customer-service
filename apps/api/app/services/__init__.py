...
_DOMAIN_GROUPS = {
    ...
    "sales": (
        ...
        "care_manual_service",
        "legacy_talk_script_cleanup_service",
        "sales_action_service",
        "sales_signal_service",
        "sales_stage_service",
        "sales_stage_migration_service",
        "sales_stage_knowledge_policy",
        "sales_stage_catalog",
        "shipping_contact_service",
        "tag_catalog",
        "tagger_service",
        "unpurchased_sop_service",
    ),
    "catalog": (
    ...
    "decisioning": (
        ...
        "policy_engine",
        "prompt_builder",
        "reply_workflow_graph",
        "reply_planner",
        "reply_guard_service",
        "reply_builder",
        "rule_guard_service",
        "template_service",
        "template_reply_service",
    ),
...
_INTEGRATION_GROUPS = {
    ...
    "web": ("link_card_metadata_service", "link_card_thumbnail_service"),
}
_MODULE_PATHS = {
