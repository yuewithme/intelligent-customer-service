...
from app.infrastructure.database.models import MemoryIdentityModel, MemorySubjectModel
from app.domains.customers.schemas.memory import MemoryIdentityRead, MemorySubjectRead
