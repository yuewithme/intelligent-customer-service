...
MEMBERSHIP_CARE_PAIN_SALES_SCRIPT = (
    "{profile_lead}{service_need}确实挺让人头疼的。我们萧岚苑服务过很多有类似情况的兰友，"
    "会结合家里的环境陪着把养护思路慢慢理顺，尽量避免同样的问题反复出现。"
)
MEMBERSHIP_CARE_PAIN_ROOT_ROT_SCRIPT = (
    "{profile_lead}连续出现{service_need}确实挺打击信心的。我们萧岚苑服务过很多有类似情况的兰友，"
    "不只是告诉一次处理方法，也会结合家里的环境陪着把养护节奏慢慢调顺。"
)
MEMBERSHIP_CARE_PAIN_BLACK_SPOT_SCRIPT = (
    "{profile_lead}{service_need}最麻烦的是容易扩散和反复。我们萧岚苑更重视陪兰友把日常预防和养护节奏理顺，"
    "遇到变化时也能结合实际情况及时调整。"
)
MEMBERSHIP_CARE_PAIN_YELLOW_TIP_SCRIPT = (
    "{profile_lead}{service_need}背后的原因比较多，单看表面很容易判断偏。我们萧岚苑会陪兰友结合实际环境，"
    "把水肥、光照和根系状态这些基础环节逐步理清。"
)
MEMBERSHIP_CARE_PAIN_NO_BLOOM_SCRIPT = (
    "{profile_lead}{service_need}不能只看光照，还要结合品种、苗情和肥力。我们萧岚苑会根据品种和家里的实际环境，"
    "陪兰友逐项调整，不让您只能靠猜着试。"
)
MEMBERSHIP_CARE_PAIN_LOSS_FEAR_SCRIPT = (
    "{profile_lead}{service_need}这种经历确实很打击信心。我们萧岚苑服务过很多新手兰友，"
    "更希望有人结合您自己的环境，陪着把基础养护一步步理顺。"
)
