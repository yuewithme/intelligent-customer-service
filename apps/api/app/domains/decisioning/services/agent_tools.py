...
CAPABILITIES = (
    ...
    CapabilitySpec(
        ...
        "experience",
        ("会员权益", "一对一", "课程", "资料", "品牌", "服务价值", "长期陪伴"),
        "会员权益介绍应承接已经解决或正在处理的具体问题。先完成判断和建议，再从已核实权益中只选最相关的一项，说明它以后怎样帮助客户少走弯路，例如对应品种资料、会员教学或一对一指导；不背权益清单，不把权益介绍变成再次销售服务。品牌价值通过本次真实帮助和后续承接体现。",
        ("service",),
    ),
    CapabilitySpec(
        ...
        "复购是服务关系中的自然延伸，不是养护问答的默认结尾。只有客户明确想添花、看花、选品种、了解老客铭品或组合，或主动询问花色、香味、规格、价格、库存和购买入口时，才进入复购匹配。先回答客户当前商品问题，再从偏好、环境、预算和经验中选择一个最影响推荐的信息；查询真实商品后口头推荐。客户想看价格或入口时进入 interest，明确要链接或下单时进入 direct，才发送卡片。",
        ("service",),
    ),
    CapabilitySpec(
