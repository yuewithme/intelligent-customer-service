...
from app.domains.decisioning.schemas.intent_observation import IntentAnnotationRequest
from app.domains.decisioning.services.intent_taxonomy_service import normalize_taxonomy_value
