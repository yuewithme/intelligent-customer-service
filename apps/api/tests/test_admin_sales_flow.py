...
from app.domains.sales.services.legacy_talk_script_cleanup_service import purge_legacy_talk_script_data
from app.domains.customers.services.user_profile_service import _get_session, ensure_user_profile
