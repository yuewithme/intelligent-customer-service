...
from app.domains.catalog.services.product_sales_copy_service import (
...
async def test_generate_sales_copy_retries_invalid_response(monkeypatch):
    ...
    monkeypatch.setattr(
        "app.domains.catalog.services.product_sales_copy_service.generate_answer",
...
async def test_generate_sales_copy_retries_transient_provider_failure(monkeypatch):
    ...
    monkeypatch.setattr("app.domains.catalog.services.product_sales_copy_service.generate_answer", fake_generate_answer)
    monkeypatch.setattr("app.domains.catalog.services.product_sales_copy_service.asyncio.sleep", no_sleep)
