...
def test_production_modules_cannot_bypass_eyun_outbound_gateway():
    violations: list[str] = []
    eyun_services = APP_DIR / "integrations" / "eyun" / "services"
    raw_transport = eyun_services / "eyun_callback_service.py"
    queue_worker = eyun_services / "message_risk_control_service.py"
